...
echo "$compID"
curl -su ${apiUser}:${apiPW} -H "content-type: text/xml" "${jssURL}/JSSResource/computergroups/id/$groupID/name/$groupName" -X PUT -d "<computer_group><computer_additions><computer><id>$compID</id></computer></computer_additions></computer_group>"
